...
���*����so do not attempt to call any secure web services in this method.
    ...
    public void start() {
        ...
        //call Registration Featur to check registration
 
 //         AdfmfContainerUtilities.gotoFeature("com.tamcapp.mobilebook.reg.Registration");
    ...
    public String getSourceAuthorizationId() {
        /* this returns the ID of the application that is allowed to
      * send push notifications.
      * */

        String senderId = "179044738550";

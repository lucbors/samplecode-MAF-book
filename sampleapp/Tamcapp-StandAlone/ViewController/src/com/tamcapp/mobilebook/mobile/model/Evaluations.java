...
import com.tamcapp.mobilebook.mobile.pojos.Evaluation;
import com.tamcapp.mobilebook.mobile.pojos.ScoreCount;
...
public class Evaluations {
    ...
    public Evaluation[] getEvaluations() {
          ...
          evaluations = (Evaluation[]) s_evaluations.toArray(new Session[s_evaluations.size()]);
          return evaluations;
        } 
}
